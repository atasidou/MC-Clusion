...
public class TextProc {
	...
	public static void TextProc(boolean flag, String pwd)
		...
		try {
			...
			System.out.println("\n Total Time of Text Extraction (ns): " + (endTime1 - startTime1));
			System.out.println("\n Number of files: " + listOfFile.size());
			System.out.println("\n Time of Text Extraction per file (ns): " + (endTime1 - startTime1) / listOfFile.size());
		...
		// ***********************************************************************************************//
		if (flag) {
			SetMultimap<Integer, String> partitions = Partition.partitioning(TextExtractPar.lp1);
		}
