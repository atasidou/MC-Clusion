...
public class Partition {
	...
	public static SetMultimap<Integer, String> partitioning(SetMultimap<String, String> lookup) {

		// Partitions Creation
		Set<String> keys = lookup.keySet();

		int partitionId = 0;
		SetMultimap<Integer, String> partitions = HashMultimap.create();
		int counter2 = 0;
		...
		for (String key : keys) {
			...
			SetMultimap<Integer, String> partitionsTMP = HashMultimap.create();
			...
			partitions = HashMultimap.create(partitionsTMP);
			partitionsTMP.clear();
			interTMP.clear();
